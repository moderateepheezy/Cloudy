...
extension SettingsViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .units:
            ...
            viewModel = SettingsViewUnitsViewModel(unitNotation: unitnotation)
        case .temperature:
            guard let temparatureNotation = TemperatureNotation(rawValue: indexPath.row) else {
                fatalError("Unexpected Index")
            }
            viewModel = SettingsViewTemperatureViewModel(tempNotation: temparatureNotation)
        }
