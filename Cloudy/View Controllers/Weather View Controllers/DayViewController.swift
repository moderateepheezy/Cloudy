...
class DayViewController: WeatherViewController {
    ...
    private func updateView() {
        ...
        if let viewModel = viewModel {
            updateWeatherDataContainer(viewModel: viewModel)
    ...
    private func updateWeatherDataContainer(viewModel: DayViewViewModel) {
        ...
        temperatureLabel.text = viewModel.temparature
